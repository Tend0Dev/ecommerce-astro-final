import { c as createComponent, a as createAstro, d as renderComponent, e as renderHead, b as renderScript, r as renderTemplate, f as addAttribute } from '../chunks/astro/server_C2wD1PaE.mjs';
import 'kleur/colors';
import { $ as $$Header } from '../chunks/Header_3mcUBbRI.mjs';
import { h as getUserProducts } from '../chunks/queries_CK1OoBgf.mjs';
/* empty css                                         */
...
</button> </div> </div> </div>`)} </div>`} </div> ${renderScript($$result, "C:/Users/tendo/OneDrive/Desktop/ecommerce-astro-final/src/pages/mis-productos.astro?astro&type=script&index=0&lang.ts")}  </body> </html>`;
}, "C:/Users/tendo/OneDrive/Desktop/ecommerce-astro-final/src/pages/mis-productos.astro", void 0);

const $$file = "C:/Users/tendo/OneDrive/Desktop/ecommerce-astro-final/src/pages/mis-productos.astro";
